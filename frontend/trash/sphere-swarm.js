// ─── SPHERE: SWARM (Enjambre de Partículas sobre malla esférica) ─────────────
// Convertido a fábrica: createSwarmSphere(container) -> { setState, destroy }
// ───────────────────────────────────────────────────────────────────────────

function createSwarmSphere(container) {
    const SPHERE_SIZES = {
        IDLE: 0.6,
        WAKE_DETECTED: 1.0,
    }
